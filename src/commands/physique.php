...
->setOptions(
    Option::new('chapitres', 'Tout les chapitres de Physique')->setRequired(true)->setType(CommandOption::INTEGER)->addChoices(
        ...
        OptionChoice::new('Accumulateur au plomb/pile à combustible', 5),
        OptionChoice::new('Décharge d\'accumulateur', 6),
        OptionChoice::new('Réaction acido/basique + le PH', 7),
        OptionChoice::new('Vecteur force', 8),
        OptionChoice::new('Mouvement des forces', 9),
        OptionChoice::new('Grandeur sinusoïdales', 10),
        ...
        OptionChoice::new('Onde électromagnétique', 14),
    ))
